...
st.write("Upload your CSV and Images (ZIP) below to generate a clean, aligned PDF catalogue.")
...
if st.button("Generate Catalogue PDF"):
    if csv_upload and zip_upload:
        with st.spinner('Processing... Please wait!'):
            ...
            with open("temp_images.zip", "wb") as f:
                f.write(zip_upload.getbuffer())
        ...
        st.error("Please upload both CSV and ZIP files first.")
